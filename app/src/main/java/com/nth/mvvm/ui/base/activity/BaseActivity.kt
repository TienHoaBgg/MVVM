...
import com.nth.mvvm.ui.utils.permision.PermissionGrantUtils
...
abstract class BaseActivity : AppCompatActivity(), ViewActivity, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    fun appDatabase() = (applicationContext as HoleApplication).appDatabase()
    fun schedule() = (applicationContext as HoleApplication).schedule()
}
